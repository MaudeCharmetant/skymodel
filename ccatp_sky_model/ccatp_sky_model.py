...
def ccatp_sky_model(freq, sensitivity = None, components = 'all', red_noise = False,p=1, cl_file = None, lensed = True, out_file = None, nside_out = 4096, lmax = None, beam_FWHM = None, template = 'WebSky', unit = 'cmb'):
    ...
    if red_noise is True:
        if sensitivity is not None:
            ...
            sensitivity = None
            if p is not None: 
                allsky_map += simulate_atmosphere(freq, nside_out = nside_out, lmax = lmax, beam_FWHM = None, unit = unit, white=True,s=1)*0.7+simulate_atmosphere(freq, nside_out = nside_out, lmax = lmax, beam_FWHM = None, unit = unit, white=True,s=100+p)*0.3
            else:		
            ...
            if p is not None: 
                allsky_map += simulate_atmosphere(freq, nside_out = nside_out, lmax = lmax, beam_FWHM = None, unit = unit, white=False,s=1)*0.7+simulate_atmosphere(freq, nside_out = nside_out, lmax = lmax, beam_FWHM = None, unit = unit, white=True,s=100+p)*0.3
            else:		
